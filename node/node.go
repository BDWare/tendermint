...
import (
	...
	bcv0 "github.com/bdware/tendermint/blockchain/v0"
	bcv1 "github.com/bdware/tendermint/blockchain/v1"
	bcv2 "github.com/bdware/tendermint/blockchain/v2"
	cfg "github.com/bdware/tendermint/config"
	"github.com/bdware/tendermint/consensus"
	cs "github.com/bdware/tendermint/consensus"
	...
	rpccore "github.com/bdware/tendermint/rpc/core"
	ctypes "github.com/bdware/tendermint/rpc/core/types"
	grpccore "github.com/bdware/tendermint/rpc/grpc"
	rpcserver "github.com/bdware/tendermint/rpc/jsonrpc/server"
	sm "github.com/bdware/tendermint/state"
	"github.com/bdware/tendermint/state/txindex"
...
func NewNode(config *cfg.Config,
	...
	// createSwitchWithLibp2p create a switch using host or not (if host is nil)
	sw := createSwitchWithLibp2p(
		config, transport, p2pMetrics, peerFilters, mempoolReactor, bcReactor,
		consensusReactor, evidenceReactor, nodeInfo, nodeKey, p2pLogger, host,
	)
